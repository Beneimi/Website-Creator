...
export class PageMapper extends Mapper<Page> {
  static toDomain (pageDTO: PageDTO): Page {
    let page = new Page(pageDTO.title, pageDTO.content, pageDTO.ownerId, pageDTO.url)
  ...
  static toDTO (page: Page): PageDTO {
    ...
    return new PageDTO(page.id, page.content, page.ownerId, page.title, page.url, modules)
  }
}*/
